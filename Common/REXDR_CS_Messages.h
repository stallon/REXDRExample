...
#ifndef __REXDR_REXDR_CS_MESSAGES_H_AADBDDBE_5CC5_11E2_A0C1_415645000030__
#define __REXDR_REXDR_CS_MESSAGES_H_AADBDDBE_5CC5_11E2_A0C1_415645000030__
...
public:
	...
	QueryUserSessionStatus( const std::string& userid = "" ) :
		command( REXDR::CMD_GET ), resource( "/stallon/usersession" ), option( "userid", userid.c_str(), NULL )
	{
		_msgID = tagMsgID;
...
public:
	...
	virtual bool Load( const REXDR::Request& req )
	{
		...
		if ( option.find( "userid" ) == option.end() ) {
			return false;
		}
...
#ifndef __REXDR_MESSAGE_CLASS_UPDATEUSERSESSIONSTATUS_ID_44368586_DECLARED__
#define __REXDR_MESSAGE_CLASS_UPDATEUSERSESSIONSTATUS_ID_44368586_DECLARED__
...
#endif /* __REXDR_MESSAGE_CLASS_UPDATEUSERSESSIONSTATUS_ID_44368586_DECLARED__ */
...
#endif /* __REXDR_REXDR_CS_MESSAGES_H_AADBDDBE_5CC5_11E2_A0C1_415645000030__ */
